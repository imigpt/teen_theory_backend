...
from db.database import get_user_collection, get_project_collection, get_password_change_requests_collection
...
async def delete_user(user_id: int):
    ...
    if profile_photo:
        try:
            path = profile_photo[1:] if profile_photo.startswith('/') else profile_photo
